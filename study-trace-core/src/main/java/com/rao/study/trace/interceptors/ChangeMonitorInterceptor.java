...
public class ChangeMonitorInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (target instanceof Executor) {
            ...
            //在执行sql操作前,原数据的处理
            List<Object> changeTable = beforeProceed(dataPaser,mybatisInvocation);
     ...
     */
    public List<Object> beforeProceed(DataPaser dataPaser,MybatisInvocation mybatisInvocation){
    ...
    public void afterProceed(DataPaser dataPaser,MybatisInvocation mybatisInvocation,List<Object> changeTable){
