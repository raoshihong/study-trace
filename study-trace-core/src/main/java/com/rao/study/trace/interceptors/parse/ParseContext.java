...
public abstract class ParseContext implements DataPaser {
	 ...
	 * @throws SQLException
	 */
	public ArrayList<HashMap<String, Object>> query(MybatisInvocation mybatisInvocation, BoundSql boundSql, SqlParserInfo sqlParserInfo) throws SQLException {
...
//				whereIdList.remove(paramMap.getProperty().toLowerCase());
	...
	@Override
	public List<Object> parseAfter(MybatisInvocation mybatisInvocation, List<Object> changeDatas) throws Exception {
		Object parameter = mybatisInvocation.getParameter();
//		for (Event changeData : changeDatas) {
