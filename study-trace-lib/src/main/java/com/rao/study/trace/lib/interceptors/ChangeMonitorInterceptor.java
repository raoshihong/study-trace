package com.rao.study.trace.lib.interceptors;

import com.google.common.collect.Lists;
import com.rao.study.trace.lib.AbstractSpan;
import com.rao.study.trace.lib.interceptors.listener.ChangeEventListener;
...
import com.rao.study.trace.lib.interceptors.parse.DataPaser;
import com.rao.study.trace.lib.interceptors.parse.ParseFactory;
...
public class ChangeMonitorInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (target instanceof Executor) {
            ...
            List<ChangeEntity> changeTable = Lists.newArrayList();
     ...
     */
    public List<ChangeEntity> beforeProceed(DataPaser dataPaser, MybatisInvocation mybatisInvocation){
    ...
    public void afterProceed(DataPaser dataPaser,MybatisInvocation mybatisInvocation,List<ChangeEntity> changeTable){
